...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pysd-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13308&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pysd-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pysd` can be installed with:

```
conda install pysd
```

It is possible to list all of the versions of `pysd` available on your platform with:
